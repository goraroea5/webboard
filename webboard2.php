...
<table width="909" border="1">
  <tr>
   ...
   <td colspan = "7" align="right" style="background-color: #ad700e; color: white; "><?php echo "ชื่อผู้ใช้งาน : ".$_SESSION["username"]." &nbsp"  ;?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <?php
      if($_SESSION["level"] == "admin") 
      { 
        echo "<td><a href=\"deletewebboard.php?QuestionID=$objResult2[0]\"> Delete</a></td>";
      }
    ?>
